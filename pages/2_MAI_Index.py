...
# =====================================================
# COLOR PALETTE (same as SET dashboard)
# =====================================================
COLOR_20D_NH = "#0056A6"
COLOR_20D_NL = "#F28C28"
...
def parse_mai_data(df: pd.DataFrame) -> pd.DataFrame:
    """Parse and clean MAI data (same mapping as SET dashboard)."""
...
# -------------------------
# PANEL 2: New Highs & Lows (same style as SET dashboard)
# -------------------------
st.markdown("---")
...
# -------------------------
# PANEL 3: Market Breadth Analysis (Tabs) - same as SET dashboard
# -------------------------
st.markdown("---")
with st.expander("📊 Market Breadth Analysis", expanded=True):
    ...
    with tab3:
        ...
        if show_diff_short_long:
            ...
            # same as SET: horizontal solid line at 0 in black
        ...
        # Ratio New Highs & New Lows 20 Days
        ...
        # Ratio New Highs & New Lows 50 Days
        ...
        # Ratio New Highs & New Lows 200 Days
    ...
    # ✅ Kept same code/logic as your SET version (Days labels)
    with tab4:
        # Panel 1: 10 Days (NH10, NL10, Diff_NHNL10)
        ...
        # Panel 2: 20 Days (NH20, NL20, Diff_NHNL20)
        ...
        # Panel 3: 50 Days (NH50, NL50, Diff_NHNL50)
        ...
        # Panel 4: 100 Days (NH100, NL100, Diff_NHNL100)
        ...
        # Panel 5: 200 Days (NH200, NL200, Diff_NHNL200)
